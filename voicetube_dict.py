...
#temp.to_csv('C:\\Users\\user\\Documents\\Output_Files\\vocabulary_lookup.csv', encoding='utf-8', index = False)

# Program 
print('================================\n=VoiceTube Dictionary by Benson=\n================================\n')
print("Enter 'q' to quit\n")
file = pd.read_csv('C:\\Users\\user\\Documents\\Output_Files\\vocabulary.csv', encoding='utf-8')
        ...
        try:
            ...
            if word in file.Vocabulary.values:
                ...
                if save == 'Y':
                    ...
                    file.to_csv('C:\\Users\\user\\Documents\\Output_Files\\vocabulary.csv', encoding='utf-8', index=False)
